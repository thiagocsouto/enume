...
public class FuncionarioService {
	...
	public Funcionario salvarFuncionarios(@RequestBody Funcionario funcionario) {
	...
	public void deletarFuncionarios(@Valid @PathVariable("id") Integer id) throws Exception {
