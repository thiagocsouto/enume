...
create table funcionario(id integer auto_increment, nome varchar(60), cargo varchar(60), matrícula varchar(20), salário_bruto varchar(20), cidade varchar(60),
logradouro varchar(30), número varchar(30), complemento varchar(60), bairro varchar(60), uf varchar(60), cep varchar(40));

data_entrada date, data_saída date, 